...
import {
  ...
  useGetReleasesQuery
} from "./chunk-E3RF53OC.js";
import {
  buildValidParams as buildValidParams2,
  getStageColorByHex
} from "./chunk-LCX7D4YD.js";
import {
...
} from "./chunk-HXFQUVAC.js";
import {
  useTypedSelector
} from "./chunk-J52W5AJB.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-SI6ZXCMD.js";
import {
  useConfig
} from "./chunk-TKSXA5AL.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-K2PDEZUY.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  useDocumentActions
} from "./chunk-SVTDQ7BI.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-UW55WAYC.js";
import {
  renderAdmin
} from "./chunk-HJAN2ALJ.js";
import {
  require_omit
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-ZNC37EV5.js";
import {
  useTracking
} from "./chunk-7ZIOONYE.js";
import {
  useLicenseLimits
} from "./chunk-VXH5DZN7.js";
import {
  Table,
  useTable
} from "./chunk-5GKPTERJ.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/de.json":
      return import("./de.json-PMKELRVG.js");
    case "./translations/dk.json":
      return import("./dk.json-IQKJUZ2O.js");
    case "./translations/en.json":
      return import("./en.json-Q5WDM7YL.js");
    case "./translations/es.json":
      return import("./es.json-LVWQRPS2.js");
    case "./translations/fr.json":
      return import("./fr.json-EJQD6JVN.js");
    ...
    case "./translations/ko.json":
      return import("./ko.json-NM5D55CD.js");
    ...
    case "./translations/pl.json":
      return import("./pl.json-ZQWBSPNP.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-B3K47WB6.js");
    ...
    case "./translations/zh.json":
      return import("./zh.json-X2UWDUKK.js");
    default:
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-BQ5PDR2C.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-LOER6CUI.js").then((mod) => ({
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/ru.json":
      return import("./ru.json-LOLDPIYK.js");
    case "./translations/sk.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-HGDGRVQR.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-HFMZZIPC.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-6E3VXFM7.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-OMFIZQZT.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-6UAML3EL.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-YLI6PSKB.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-ZHQKNONC.js");
          return {
...
function __variableDynamicImportRuntime2__2(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-2XTUETKZ.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-LMBKSAZL.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-K2JVN6CH.js");
          return {
...
//# sourceMappingURL=chunk-P6V6RLEF.js.map
