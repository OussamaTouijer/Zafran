...
import {
  ...
  useGetReleasesQuery
} from "./chunk-RTITUSCU.js";
import {
  buildValidParams as buildValidParams2,
  getStageColorByHex
} from "./chunk-WSHP3YJ7.js";
import {
...
} from "./chunk-U2YE3DN6.js";
import {
  useTypedSelector
} from "./chunk-BN34EVJS.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-RVRJR2OC.js";
import {
  useConfig
} from "./chunk-SUOCVTQW.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-UXLZUFX5.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  useDocumentActions
} from "./chunk-6B3U3RDA.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-MCA6ZCA3.js";
import {
  renderAdmin
} from "./chunk-3FJUABT7.js";
import {
  require_omit
} from "./chunk-CSZPFXEB.js";
import {
  require_cloneDeep
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-HSC6GHKT.js";
import {
  useTracking
} from "./chunk-5GOPLWZT.js";
import {
  useLicenseLimits
} from "./chunk-FH3SQW6X.js";
import {
  Table,
  useTable
} from "./chunk-AX7FINLQ.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3
...
import {
  useField,
  useForm
} from "./chunk-O35BH5UK.js";
import {
  useRBAC
} from "./chunk-S4FLI6NH.js";
import {
  useAdminUsers
} from "./chunk-SS7625EV.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
} from "./chunk-JBLODRW4.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-W6ZIMHX5.js";
import {
  useNotification
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-NTNOLELN.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-CSXZA2BR.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-QDUH6B6C.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-IZDHTPQR.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-A2CB2GNA.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-VIC45SEA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-SQFAHG62.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-V6NOQFKM.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-A6RM4MSN.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-OSREMYS4.js");
          return {
...
//# sourceMappingURL=chunk-XBEVFREN.js.map
