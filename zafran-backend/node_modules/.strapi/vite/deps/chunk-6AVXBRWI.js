import {
  MagicLinkCE,
  SelectRoles
} from "./chunk-WMYNTMRO.js";
import {
  useEnterprise
} from "./chunk-REDLA426.js";
import {
  SearchInput
} from "./chunk-LPBE7XLK.js";
import {
  ConfirmDialog
...
var ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-LJILS5JJ.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-IOLLCTAZ.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-TLJRKIRD.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-6AVXBRWI.js.map
