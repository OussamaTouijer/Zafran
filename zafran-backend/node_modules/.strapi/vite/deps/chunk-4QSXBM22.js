...
import {
  reducer
} from "./chunk-7D4RM7YW.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-AKNKU2G6.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/ru.json":
      return import("./ru.json-U4OIFXKC.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-QXX6T3SL.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-4MNB4B4V.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-4MNB4B4V.js");
...
//# sourceMappingURL=chunk-4QSXBM22.js.map
