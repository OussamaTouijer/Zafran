import {
  ...
  STATES,
  VerticalDivider
} from "./chunk-XXRNVEYP.js";
import {
  RelativeTime
} from "./chunk-LZOLIP5E.js";
import {
  Widget
} from "./chunk-FEHR22YR.js";
import {
  useEnterprise
...
var GuidedTourHomepage = () => {
  ...
  const sections = Object.entries(LAYOUT_DATA).map(([key, val]) => ({
    ...
    content: (0, import_jsx_runtime2.jsx)(LinkButton, {
      onClick: () => trackUsage(val.home.trackingEvent),
      tag: NavLink,
      to: val.home.cta.target,
      endIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$5d, {}),
                  ...
                  (0, import_jsx_runtime2.jsxs)(Flex, {
                    children: [
                      (0, import_jsx_runtime2.jsx)(Box, {
                        minWidth: `3rem`,
                        marginRight: 5,
                        children: (0, import_jsx_runtime2.jsx)(Number, {
                          state,
                          children: index + 1
                        })
                      }),
                  ...
                  (0, import_jsx_runtime2.jsxs)(Flex, {
                    ...
                    children: [
                      (0, import_jsx_runtime2.jsx)(Flex, {
                        ...
                        marginTop: 3,
                        marginRight: 5,
                        children: index === sections.length - 1 ? null : (0, import_jsx_runtime2.jsx)(VerticalDivider, {
                          state
                        })
                      }),
                      (0, import_jsx_runtime2.jsx)(Box, {
...
var GuidedTour = () => {
  ...
  return (0, import_jsx_runtime3.jsx)(GuidedTourHomepage, {});
};

// node_modules/@strapi/admin/dist/admin/admin/src/pages/Home/HomePage.mjs
var WidgetRoot = ({ title, icon = ForwardRef$19, children }) => {
  const { formatMessage } = useIntl();
    ...
    children: [
      ...
      (0, import_jsx_runtime4.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime4.jsxs)(Flex, {
          ...
          paddingBottom: 10,
          children: [
            (0, import_jsx_runtime4.jsx)(GuidedTour, {}),
...
var HomePageCE = () => {
  ...
  if (window.strapi.future.isEnabled("unstableWidgetsApi")) {
    return (0, import_jsx_runtime4.jsx)(UnstableHomePageCe, {});
  }
  return (0, import_jsx_runtime4.jsxs)(Main, {
    children: [
      (0, import_jsx_runtime4.jsx)(Page.Title, {
      ...
      (0, import_jsx_runtime4.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime4.jsxs)(Flex, {
          ...
          children: [
            (0, import_jsx_runtime4.jsx)(GuidedTour, {}),
            (0, import_jsx_runtime4.jsxs)(Grid.Root, {
              gap: 5,
              children: [
                (0, import_jsx_runtime4.jsx)(Grid.Item, {
                  col: 6,
                  s: 12,
                  children: (0, import_jsx_runtime4.jsx)(WidgetRoot, {
                    title: {
                    ...
                    icon: ForwardRef$1v,
                    children: (0, import_jsx_runtime4.jsx)(LastEditedWidget, {})
                  })
                }),
                (0, import_jsx_runtime4.jsx)(Grid.Item, {
                  col: 6,
                  ...
                  children: (0, import_jsx_runtime4.jsx)(WidgetRoot, {
                    ...
                    icon: ForwardRef$4D,
                    children: (0, import_jsx_runtime4.jsx)(LastPublishedWidget, {})
                  })
                })
              ]
            })
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-KQ3NH5EF.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=chunk-WXGY77CB.js.map
